...
| --set-default-namespace или -n | NAMESPACE | имя NamespaceПримечание.: по умолчанию NAMESPACE = default |
...
|                | NAME     | имя объектаПримечание: имя объекта не должно содержать заглавных букв                                                                                                                                                                                                                                                                                                   |
