// Code generated by fileb0x at "2018-07-02 12:41:33.708747851 +0300 MSK m=+0.181677470" from config file "b0x.toml" DO NOT EDIT.
// modification hash(0dc80c49c0ab8fd7b88e0eb4e636009c.eadbe36098f6442f9c76baa8d818e914)
...
func init() {
	...
	f, err = FS.OpenFile(CTX, "run/version.md", os.O_RDWR|os.O_CREATE|os.O_TRUNC, 0777)
	if err != nil {
		panic(err)
	}

	_, err = f.Write(FileRunVersionMd)
	if err != nil {
		panic(err)
	}
